                  ...
                  {reviews.slice(0, 10).map((review, idx) => (
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span
                          className={`px-3 py-1 rounded-full text-xs font-bold ${review.sentiment_analysis?.sentiment === "positive"
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="text-right ml-4">
              <div className={`text-xl font-bold px-4 py-2 rounded-lg ${analysisStats?.overall_sentiment === 'positive' ? 'bg-green-100 text-green-700' :
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <div className={`px-3 py-1 rounded-full text-xs font-semibold ${summary.positive_percentage > 60
                            ? 'bg-green-100 text-green-800'
                            : summary.negative_percentage > 40
                              ? 'bg-red-100 text-red-800'
                              : 'bg-gray-100 text-gray-800'
          ...
          <div className="flex rounded-lg border border-gray-200 overflow-hidden bg-gray-50 mt-4 sm:mt-0">
            {[
              ...
              <Button
                ...
                size="sm"
                onClick={() => setSelectedMetric(tab.key)}
                className={`rounded-none border-0 flex items-center gap-2 px-4 py-2 ${selectedMetric === tab.key
              ...
              <div key={index} className="p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-200">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className={`text-xs px-2 py-1 rounded font-medium ${review.sentiment_analysis?.sentiment === 'positive'
                        ? 'bg-green-100 text-green-800'
                        : review.sentiment_analysis?.sentiment === 'negative'
                          ? 'bg-red-100 text-red-800'
                          : 'bg-gray-100 text-gray-800'
        ...
        {!analysisData || !analysisStats ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              ...
              <div className={`bg-gradient-to-br rounded-lg p-5 shadow-sm border ${analysisStats.overall_sentiment === 'positive'
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className={`text-3xl font-bold ${analysisStats.overall_sentiment === 'positive' ? 'text-green-700' :
                        analysisStats.overall_sentiment === 'negative' ? 'text-red-700' : 'text-gray-700'
                      }`}>
                      {analysisStats.overall_sentiment?.toUpperCase()}
                    </div>
                    <div className={`text-sm font-medium mt-1 ${analysisStats.overall_sentiment === 'positive' ? 'text-green-600' :
            ...
            <nav className="flex space-x-8">
              {tabs.map((tab) => (
                <Button
                  ...
                  className={`flex items-center space-x-2 py-4 px-1 border-b-2 font-medium text-sm transition-colors rounded-none ${activeTab === tab.id
